...
`ERR_PASSKEY_VALIDATION`, `ERR_PASSKEY_NATIVE`, `ERR_PASSKEY_CREATE`, `ERR_PASSKEY_GET`, and `ERR_PASSKEY_INVALID_RESPONSE` usually need developer attention. Log the code and message, then fail the ceremony.
